...
namespace hnrt
{
    ...
    public:
            ...
            : _uuid(uuid)
        {
            ...
            _box[0].pack_start(*Gtk::manage(_listView[0].createScrolledWindow()));
            _box[1].pack_start(_label[1], Gtk::PACK_SHRINK);
            _box[1].pack_start(*Gtk::manage(_listView[1].createScrolledWindow()));
            ...
            : _uuid(uuid)
        {
            ...
            _box[2].pack_start(*Gtk::manage(_listView[2].createScrolledWindow()));
